...
**Option 3: IONOS Cloud (Recommended by your organization)**
...
- Build and push images to <your-registry>.cr.<region>.ionos.com
...
1. **Build and tag images with your registry URL:**
   ...
   docker build -t <your-registry>.cr.<region>.ionos.com/monadic-pipeline:latest .
   docker build -f Dockerfile.webapi -t <your-registry>.cr.<region>.ionos.com/monadic-pipeline-webapi:latest .
...
2. **Push to your registry:**
   ...
   docker push <your-registry>.cr.<region>.ionos.com/monadic-pipeline:latest
   docker push <your-registry>.cr.<region>.ionos.com/monadic-pipeline-webapi:latest
