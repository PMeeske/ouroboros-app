...
resource "ionoscloud_container_registry" "main" {
  name     = var.registry_name  # "<your-registry-name>"
  location = var.location       # "de/fra"
}

output "registry_hostname" {
  value = ionoscloud_container_registry.main.hostname
  # Example: <your-registry>.cr.<region>.ionos.com
}
```
...
# Outputs:
# - registry_hostname: <your-registry>.cr.<region>.ionos.com
...
2. Are images pushed? docker images | grep <your-registry-name>
