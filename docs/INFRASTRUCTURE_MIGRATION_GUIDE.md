...
docker build -t <your-registry>.cr.<region>.ionos.com/monadic-pipeline:staging .
docker push <your-registry>.cr.<region>.ionos.com/monadic-pipeline:staging
...
kubectl set image deployment/monadic-pipeline \
  monadic-pipeline=<your-registry>.cr.<region>.ionos.com/monadic-pipeline:previous-tag \
  -n monadic-pipeline
