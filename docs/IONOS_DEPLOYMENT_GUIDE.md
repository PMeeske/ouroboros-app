...
**your organization** has chosen IONOS Cloud for its cost-effectiveness, European data sovereignty, and enterprise features.
...
IONOS_REGISTRY="<your-registry>.cr.<region>.ionos.com"
```
...
docker login <your-registry>.cr.<region>.ionos.com
...
```bash
export IONOS_REGISTRY="<your-registry>.cr.<region>.ionos.com"
...
```bash
REGISTRY="<your-registry>.cr.<region>.ionos.com"
...
kubectl create secret docker-registry ionos-registry-secret \
  --docker-server=<your-registry>.cr.<region>.ionos.com \
...
image: <your-registry>.cr.<region>.ionos.com/monadic-pipeline:latest
...
1. **IONOS_REGISTRY** (default: `<your-registry>.cr.<region>.ionos.com`)
   ```
   Settings → Variables → New repository variable
   Name: IONOS_REGISTRY
   Value: <your-registry>.cr.<region>.ionos.com
   ```
...
**your organization** - Enterprise AI Pipeline Solutions
