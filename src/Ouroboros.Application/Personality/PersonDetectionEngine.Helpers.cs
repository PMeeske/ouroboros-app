// <copyright file="PersonDetectionEngine.Helpers.cs" company="Ouroboros">
...
/// <summary>
/// Internal helper methods for person detection: name extraction, style analysis, matching, and profiling.
/// </summary>
