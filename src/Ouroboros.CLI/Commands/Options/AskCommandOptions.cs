...
/// <summary>
/// Options for the ask command using System.CommandLine 2.0.3 GA
/// </summary>
public class AskCommandOptions
{
    public System.CommandLine.Option<string> QuestionOption { get; } = new("--question")
    {
        Description = "The question to ask",
        DefaultValueFactory = _ => string.Empty
    };

    public System.CommandLine.Option<bool> RagOption { get; } = new("--rag")
    {
    ...
    {
        Description = "Agent implementation: simple|lc|react",
    ...
    // Voice options (will be handled by global voice option)
    ...
    /// <summary>
    /// Adds all ask command options to the given command.
    /// </summary>
